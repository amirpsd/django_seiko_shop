...
class CategoryImage(models.Model):
    category = models.ForeignKey('Category', default=None, on_delete=models.CASCADE, verbose_name='دسته بندی')
...
class Product(models.Model):
    ...
    description = RichTextUploadingField(default=None, verbose_name='توضیحات', blank=True)
    color = models.ManyToManyField('Color', related_name='product_color', blank=True)
    size = models.ManyToManyField('Size', verbose_name='سایز ها', related_name='product_size')
    ...
    status = models.CharField(choices=STATUS_CHOICES, max_length=3, verbose_name='وضعیت')
    category = models.ManyToManyField(Category, related_name='category', blank=True, verbose_name='دسته بندی محصولات')
