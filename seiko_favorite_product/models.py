...
from seiko_shop.models import Product
from seiko_account.models import User
...
class FavoriteProduct(models.Model):
    ...
    products = models.ManyToManyField(Product, blank=False,default=None,
                                      related_name='products_favorite_product')
